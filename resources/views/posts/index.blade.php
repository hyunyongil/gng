...
@section('content')
    ...
    <div class="container">
        ...
        <form id="search-form" method="GET">
            <input type="hidden" name="num" value="{{$getData['num']}}">
            <input type="hidden" name="category" value="{{$getData['category']}}">
            <table class="table_04">
                <caption></caption>
                <tbody>
                <tr>
                    ...
                    <td>
                        <input type="text" title="검색" name="search_itemNo" class="input1"
                               value="{{ $getData['search_itemNo'] }}" style="width:400px;"/>
            ...
            <div class="t30 ac">
                <button class="button13" type="submit"
                        style="width:150px; height:43px;">결과내재검색
                </button>
                &nbsp;
                <button class="button14" onClick="{{ _url_('posts') }}"
                        style="width:150px; height:43px;">검색초기화
                </button>
            </div>
        </form>
        ...
        <div class="fl">
            ...
            <div style="display:inline-block;" class="l05 prod_tbl_tit1">총 {{$count}}건이 검색되었습니다</div>
            <div style="display:inline-block;" class="l05">
                ...
                <button class="button20" style="background:#0c5460; width:120px;" type="button"
                        onClick="javascript:window.location.href = '{{ _url_('posts/create') }}';return false">상품등록
                </button>
            </div>
        ...
        <div class="">
            ...
            <!--
                ...
                -->
                <select name="select"
                        onChange="window.location='posts?search_itemNo={{$getData['search_itemNo']}}&category=01_02_03_04&num='+options[(this.selectedIndex)].value"
                        class="select1">
                    <option value="20" {{ ($getData['num'] == 20)?'selected':'' }}>20개씩 보기</option>
                    <option value="30" {{ ($getData['num'] == 30)?'selected':'' }}>30개씩 보기</option>
                    <option value="50" {{ ($getData['num'] == 50)?'selected':'' }}>50개씩 보기</option>
                    <option value="100" {{ ($getData['num'] == 100)?'selected':'' }}>100개씩 보기</option>
                </select>
            </div>
            ...
            <table class="table02_l" style="border:1px solid #dddddd">
                ...
                @foreach($itemData as $data)
                    <tr class="sub_cont_bane2_tr">
                        <td>
                            <div class="input_check3_">
                                <label for="SE{{$data->no}}"><input type="checkbox" name="itemNoArr"
                                                                    class="input_check3 itemNoArr"
                                                                    value="{{$data->itemNo}}"
                                                                    id="SE{{$data->no}}"/><span
                        ...
                        <td class="al">
                            <div class="txt39"><strong style="color:#000">{{$data->itemNo}}</strong> / <strong
                                    style="color:#000">{{$data->sellerNick}}</strong>({{$data->sellerId}})
                        ...
                        <td>
                            <button class="button20" style="background:#cf6d34; width:100px;" type="button"
                                    onClick="javascript:window.location.href = '{{ _url_('posts/'.$data->no.'/edit') }}';return false">
                                상품수정
                            </button>
                        </td>
                    </tr>
        ...
        <div class="col-md-12">
            <div class="page_number">
                {!! $itemData->appends($getData)->links() !!}
            </div>
        </div>
    ...
    <div id="footer_position2">


        <div class="footer_position2_bg2">
            <div class="container">
                <div class="fl">
                    <a href="javascript:vo()" class="footer_btn2"><img src="{{ _url_('web/img/main/footer_btn2.jpg') }}"
                                                                       alt=""/></a>
                </div>
        ...
        <div class="footer_position2_bg">
            <div class="container">
                <div class="fl">
                    <a href="javascript:vo()" class="footer_btn1"><img src="{{ _url_('web/img/main/footer_btn1.jpg') }}"
                                                                       alt=""/></a>
                </div>

                <ul class="ufl l30 t15 fl">
                    <li>
                        <button class="footer_position_btn1" type="submit" style="background:#227547; color:#ffff;"
                                onClick="javascript:popup('pup8.html', '1000','800', 'yes');return false"><img
                                src="{{ _url_('web/img/main/main_cont_btn1_bu2.png') }}" class="vm" alt=""> 선택마켓별설정
                        </button>
                    </li>


                    <li class="l10">
                        <button class="footer_position_btn1" type="submit"
                                style="border:1px solid #0ba79e; background:#0ba79e; width:200px"
                                onClick="javascript:popup('sub3_1_pup.html', '1550','800', 'yes');return false"><img
                                src="{{ _url_('web/img/main/icon1.png') }}" class="vm" alt=""> 엑셀대량주문서설정
                        </button>
                    </li>
                    ...
                    <li class="l10">
                        <button class="footer_position_btn1" type="submit"
                                style="border:1px solid #9a54d5; background:#9a54d5; width:150px"
                                onClick="window.location.href='#1'"><img src="{{ _url_('web/img/main/icon2.png') }}"
                                                                         class="vm" alt=""> 선택폴더이동
                        </button>
                    </li>

                    <li class="l10">
                        <button class="footer_position_btn1" type="button" id="deleteData"
                                style="border:1px solid #3880eb; background:#3880eb; width:150px"><img
                                src="{{ _url_('web/img/main/icon3.png') }}"
                                class="vm" alt=""> 선택일괄삭제
                        </button>
                    </li>
                ...
                <div class="fr">
                    <a href="#"><img src="{{ _url_('web/img/sub/btn3.png') }}" class="vm" alt=""/></a> <span
                        style="color:#fff; line-height:70px;">선택상품수 <strong style="color:#f26820">20</strong>개</span>
                    &nbsp;&nbsp;&nbsp;
                    <a href="javascript:vo()" class="gotop"><img src="{{ _url_('web/img/main/footer_btn3.png') }}"
                                                                 alt=""/></a>
                    <a href="javascript:vo()" class="totop_m2"><img src="{{ _url_('web/img/main/footer_btn4.png') }}"
                                                                    alt=""/></a>
                </div>
    ...
    <script>
        $(document).ready(function () {
            $("#w1").click(function () {
                if ($(this).is(':checked')) {
                    $(".itemNoArr").attr('checked', true);
                } else {
                    $(".itemNoArr").attr('checked', false);
                }
            });
        });
        ...
        $("#deleteData").click(function () {
            if (confirm('삭제하실건가요?')) {
                let data = $('#index-form').serializeArray();
                $.post('{{ _url_('posts') }}/deleteItem', {
                    'data': data,
                    '_token': '{{ csrf_token() }}'
                }, function (data) {
                    if (data.state === 0) {
                        layer.msg(data.msg, {time: 2000});
                        window.location.href = '{!!  _url_('posts?'.http_build_query($getData))  !!}';
                    } else {
